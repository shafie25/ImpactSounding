...
#
# Loads Labeled_Features.xlsx, trains a Random Forest,
# evaluates performance, and saves results + plots to
# Classifier Results/RandomForest/
# ============================================================
...
OUTPUT_DIR    = os.path.join("Classifier Results", "CrackDetection", "RandomForest")
RANDOM_STATE  = 42
...
# class_weight='balanced' compensates for 4.6x class imbalance
...
precision = precision_score(y_test, y_pred, pos_label=0)   # positive = Cracked
...
ax.set_ylim(0, 1.1)
ax.set_ylabel("Score")
ax.set_title("Random Forest — 5-Fold CV Scores (mean +/- std)")
